...
urlpatterns = [
    ...
    path('delete-tag-list/', views.TagsListView.as_view(template_name='catalog/tags_delete_list.html'),
    ...
    path('items-confirm-list/', views.ItemConfirmList.as_view(template_name='catalog/main_page.html'),
         name='confirm-items'),
